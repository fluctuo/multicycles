<template>
  <div>
    ...
    <p>
      Some providers has only stations (dock system) or are hybrid. Stations are mixed on
      <nuxt-link :to="{ name: 'docs-type-value', params: { type: 'Query', value: 'vehicles' }}">Vehicles Query</nuxt-link>. Provider with stations ll implement both interface,
      <nuxt-link :to="{ name: 'docs-type-value', params: { type: 'Types', value: 'Vehicle' }}">Vehicle</nuxt-link> and
      <nuxt-link :to="{ name: 'docs-type-value', params: { type: 'Types', value: 'Station' }}">Station</nuxt-link> (eg
      <nuxt-link :to="{ name: 'docs-type-value', params: { type: 'Types', value: 'Nextbike' }}">Nextbike</nuxt-link>). <br> You can have station detail with
      <a href="https://graphql.org/learn/queries/#inline-fragments">GraphQL Inline fragment</a>.
    </p>
