...
const onlyTypes = ['Provider', 'Capacities', 'Bird', 'Byke', 'CallABike', 'Coup', 'Donkey', 'GobeeBike', 'Hellobike', 'IndigoWheel', 'Jump', 'Lime', 'Mobike', 'Nextbike', 'Obike', 'Ofo', 'Pony', 'Spin', 'WhiteBikes', 'Yobike']
