<template>
  <div class="flex-container">
    <div class="map-container">
      ...
      <l-map ref="map" :zoom=map.zoom :minZoom=map.minZoom :center=map.center @moveend="moveCenter" @dragstart="moveStart" @zoomend="zoomEnd" :options=map.options style="height: 100%">
